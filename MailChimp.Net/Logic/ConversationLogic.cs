...
namespace MailChimp.Net.Logic
{
    ...
    internal class ConversationLogic : BaseLogic, IConversationLogic
    {
        ...
        public async Task<IEnumerable<Conversation>> GetAllAsync(ConversationRequest request = null, CancellationToken cancellationToken = default) 
            => (await GetResponseAsync(request, cancellationToken).ConfigureAwait(false))?.Conversations;
        ...
        /// <exception cref="NotSupportedException"><paramref name="element" /> is not a constructor, method, property, event, type, or field. </exception>
        /// <exception cref="TypeLoadException">A custom attribute type cannot be loaded. </exception>
        public async Task<ConversationResponse> GetResponseAsync(ConversationRequest request = null, CancellationToken cancellationToken = default)
        {
