...
internal class ApiLogic : BaseLogic, IApiLogic
{
    ...
    public async Task<ApiInfo> GetInfoAsync(CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Ping> PingAsync(CancellationToken cancellationToken = default)
    {
