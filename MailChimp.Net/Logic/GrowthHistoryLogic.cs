...
public class GrowthHistoryLogic : BaseLogic, IGrowthHistoryLogic
{
    ...
    public async Task<IEnumerable<History>> GetAllAsync(string listId, QueryableBaseRequest request = null) => (await GetResponseAsync(listId, request).ConfigureAwait(false))?.History;
