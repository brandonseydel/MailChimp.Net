...
public interface ICampaignLogic
{
    ...
    /// </returns>
    [Obsolete]
    Task<Campaign> AddOrUpdateAsync(string campaignId, Campaign campaign, CancellationToken cancellationToken = default);
    ...
    /// The <see cref="Task"/>.
    /// </returns>
    Task CancelAsync(string campaignId, CancellationToken cancellationToken = default);
    ...
    /// The <see cref="Task"/>.
    /// </returns>
    Task<Campaign> GetAsync(string id, CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    Task ExecuteCampaignActionAsync(string campaignId, CampaignAction campaignAction, CancellationToken cancellationToken = default);
    ...
    /// The <see cref="Task"/>.
    /// </returns>
    Task TestAsync(string campaignId, CampaignTestRequest content = null, CancellationToken cancellationToken = default);
    ...
    /// The <see cref="Task"/>.
    /// </returns>
    Task ScheduleAsync(string campaignId, CampaignScheduleRequest content = null, CancellationToken cancellationToken = default);
    ...
    /// The <see cref="Task"/>.
    /// </returns>
    Task UnscheduleAsync(string campaignId, CampaignScheduleRequest content = null, CancellationToken cancellationToken = default);
    ...
    /// <exception cref="NotSupportedException"><paramref name="element" /> is not a constructor, method, property, event, type, or field. </exception>
    /// <exception cref="TypeLoadException">A custom attribute type cannot be loaded. </exception>
    Task<CampaignResponse> GetResponseAsync(CampaignRequest request = null, CancellationToken cancellationToken = default);
    Task<SendChecklistResponse> SendChecklistAsync(string id, CancellationToken cancellationToken = default);
}