    ...
    public class CampaignTest : MailChimpTest
    {
        ...
        public async Task Should_Delete_Campaign()
        {
            ...
            if (campaign != null)
            {
                ...
                var campaignsnow = await this.MailChimpManager.Campaigns.GetAllAsync().ConfigureAwait(false);
        ...
        {
            var campaigns = await this.MailChimpManager.Campaigns.GetAll().ConfigureAwait(false);
